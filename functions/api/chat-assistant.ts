...
const SYSTEM_PROMPT = `你是一個公司秘書管理系統的 AI 助手。你可以幫助用户管理公司資料、人員、股東，以及生成 PDF 文件。
...
當用户要求查詢或操作資料時，使用提供的工具函數。
回覆時使用繁體中文。
如果用户要求生成 PDF，告訴他們可以在公司管理頁面的公司卡片上點擊「生成 NAR1」按鈕。
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          company_group: { type: "string", description: "公司羣組" },
        },
        required: ["name"],
      },
    },
